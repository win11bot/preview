...
const FourOhFour = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(Message, { className: "return-link", href: "https://github.com/blueedgetechno/win11React", rel: "noreferrer noopener" }, "Return to GitHub"), /*#__PURE__*/


    React.createElement(Logo, { className: "bear-logo--tears" }), /*#__PURE__*/
    React.createElement(Code, { className: "four-oh-four__code" }, "Preview"), /*#__PURE__*/
    React.createElement(CodeMessage, { className: "four-oh-four__code-message" }, "Uploading"))));
